...
namespace AmadeusBlog.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {                
                ...
                var user = new BlogUser
                {
                    ...
                    ImageData = (
                        await _imageService
                                .EncodeFileAsync(Input.ImageFile)) ??
                        await _imageService
                                .EncodeFileAsync(_configuration["DefaultUserImage"]),
